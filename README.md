...
![MC Version](https://img.shields.io/badge/Minecraft-1.16--1.21.11-green)
![License](https://img.shields.io/badge/License-MIT-blue)

**Home and Warp (简称 haw)** 是一个适用于 Minecraft Fabric 1.16 至 1.21.11 的轻量级服务端传送模组。它提供了完善的个人传送点（Home）和共享传送点（Warp）系统，支持点击交互、注释搜索、时间排序以及数量限制管理。
...
模组数据文件位于对应存档或服务端世界目录下的 `haw/` 文件夹中：
...
| Minecraft | 源码目录 |
| :--- | :--- |
| 1.16-1.16.5 | `1.16-1.16.5` |
| 1.17-1.17.1 | `1.17-1.17.1` |
| 1.18-1.18.2 | `1.18-1.18.2` |
| 1.19-1.19.2 | `1.19-1.19.2` |
| 1.19.3-1.19.4 | `1.19.3-1.19.4` |
...
4.  编译后的文件位于各版本子项目的 `build/libs/` 目录。
